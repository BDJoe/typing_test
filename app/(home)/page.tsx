	...
	return (
		<div className='flex items-center justify-center min-w-screen min-h-screen max-md:py-8 max-md:px-6 max-md:m-4 font-mono p-20 leading-[1.6]'>
			<div
				className={
					roundComplete && results
						? "max-w-250 w-full bg-[#111111] rounded-2xl border-[#222222] border-2 p-12 shadow-[0_8px_32px_rgba(0,0,0,0.4)] transition-all duration-300 ease-in-out opacity-100 absolute"
						: "opacity-0 max-w-250 w-full bg-[#111111] rounded-2xl border-[#222222] border-2 p-12 shadow-[0_8px_32px_rgba(0,0,0,0.4)] transition-all duration-300 ease-in-out absolute pointer-events-none"
				}
			>
			...
			<div
				className={
					!roundComplete
						? "opacity-100 transition-all duration-300 ease-in-out absolute"
						: "opacity-0 transition-all duration-300 ease-in-out absolute pointer-events-none"
				}
			>
				{!isFocused && isActive && (
					<div
				...
				>
					...
					>
						...
						<div
							className={
								!isActive && !isPaused
									? "opacity-100 mb-0 transition-all duration-300 ease-in-out"
									: "opacity-0 mb-0 transition-all duration-300 ease-in-out"
							}
						>
							<SettingsCard
						...
						<div
							className={
								isActive
									? "opacity-100 mb-20 transition-all duration-300 ease-in-out"
									: "opacity-0 mb-0 transition-all duration-300 ease-in-out"
							}
						>
